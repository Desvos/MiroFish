...
Encapsulates graph search, node reading, and edge query tools for Report Agent
...
class InsightForgeResult:
    ...
    # Retrieval results from each dimension
    ...
    def to_text(self) -> str:
        ...
        if self.key_quotes:
            ...
            for quote in self.key_quotes:
                ...
                # Filter out garbage content containing question numbers (question 1-9)
                skip = False
                for d in '123456789':
                ...
                if skip:
                    continue
                # Truncate overly long content (by period, not hard truncate)
...
class ZepToolsService:
    ...
    def get_all_edges(self, graph_id: str, include_temporal: bool = True) -> List[EdgeInfo]:
        """
        Get all edges in the graph (paginated retrieval, including temporal information)
    ...
    def get_node_edges(self, graph_id: str, node_uuid: str) -> List[EdgeInfo]:
        ...
        Retrieves all edges in the graph, then filters to find edges related to the specified node
    ...
    def get_simulation_context(
        ...
        Comprehensively search for all information related to simulation requirement
    ...
    def insight_forge(
        ...
        Most powerful hybrid retrieval function, automatically decomposes questions and retrieves from multiple dimensions:
...
Return JSON format sub-question list."""
    ...
    def panorama_search(
        ...
        This tool is suitable for scenarios that require understanding the full picture of events and tracking evolution processes.
    ...
    def interview_agents(
        ...
        4. Call /api/simulation/interview/batch interface for real interviews (dual-platform simultaneous interview)
        5. Integrate all interview results to generate interview report
        ...
        - Need to get real responses from simulated Agents (not LLM simulated)
        ...
        INTERVIEW_PROMPT_PREFIX = (
            ...
            "combining your persona, all past memories and actions.\n"
            ...
            "4. Answer each question one by one, each response starting with \"Question X:\" (X is the question number)\n"
            "5. Separate each answer with a blank line\n"
            "6. Answers should have substantial content, each question answered with at least 2-3 sentences\n\n"
        )
        optimized_prompt = f"{INTERVIEW_PROMPT_PREFIX}{combined_prompt}"

        # Step 4: Call real interview API (not specifying platform, default dual-platform simultaneous interview)
        try:
            # Build batch interview list (not specifying platform, dual-platform interview)
            interviews_request = []
            ...
            # Call SimulationRunner batch interview method (not passing platform, dual-platform interview)
            api_result = SimulationRunner.interview_agents_batch(
                simulation_id=simulation_id,
                interviews=interviews_request,
                platform=None,  # Not specifying platform, dual-platform interview
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                # Strategy 1 (main): Extract complete meaningful sentences
                ...
                # Strategy 2 (supplementary): Long text in correctly paired Chinese quotes
                if not key_quotes:
                ...
                interview = AgentInterview(
                    ...
                    agent_bio=agent_bio[:1000],  # Increased bio length limit
            ...
            result.summary = f"Error during interview process: {str(e)}"
            return result
    ...
    def _load_agent_profiles(self, simulation_id: str) -> List[Dict[str, Any]]:
        ...
        # Try to read Reddit JSON format first
    ...
    def _select_agents_for_interview(
        ...
        system_prompt = """You are a professional interview planning expert. Your task is to select the most suitable Agents to interview from the simulated Agent list based on interview requirements.

Selection criteria:
1. Agent's identity/profession should be related to the interview topic
...
5. Each question should be concise, within 50 characters
6. Direct questions, without background explanations or prefixes
...
1. Summarize main viewpoints from all parties
2. Point out consensus and differences in viewpoints
...
- Use Chinese quotes「」when quoting interviewees' original words
