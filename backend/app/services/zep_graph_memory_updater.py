...
class AgentActivity:
    ...
    def to_episode_text(self) -> str:
        ...
        Use natural language description format so Zep can extract entities and relations
        Don't add simulation-related prefixes to avoid misleading graph updates
        """
        ...
        # Directly return "agent name: activity description" format, don't add simulation prefix
    ...
    def _describe_create_comment(self) -> str:
        """Post comment - includes comment content and post info being commented on"""
        content = self.action_args.get("content", "")
        post_content = self.action_args.get("post_content", "")
        post_author = self.action_args.get("post_author_name", "")
...
class ZepGraphMemoryUpdater:
    ...
    Group by platform, batch send to Zep after accumulating BATCH_SIZE activities.

    All meaningful behaviors will be updated to Zep, action_args contains complete context info:
    - Original post for like/dislike
    - Original post for repost/quote
    - Followed/muted username
    - Original comment for like/dislike
    """
    ...
    # Send interval (seconds), avoid requests being too fast
    SEND_INTERVAL = 0.5
    ...
    def __init__(self, graph_id: str, api_key: Optional[str] = None):
        ...
        # Platform-grouped activity buffer (each platform accumulates to BATCH_SIZE then batch sends)
    ...
    def add_activity(self, activity: AgentActivity):
        ...
        All meaningful behaviors will be added to queue, including:
        ...
        action_args contains complete context info (like post content, username, etc.).
                ...
                try:
                    ...
                    with self._buffer_lock:
                        ...
                        if len(self._platform_buffers[platform]) >= self.BATCH_SIZE:
                            ...
                            # Send interval, avoid requests being too fast
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "buffer_sizes": buffer_sizes,                # Each platform buffer size
...
class ZepGraphMemoryManager:
    """
    Manage multiple simulation Zep graph memory updaters
