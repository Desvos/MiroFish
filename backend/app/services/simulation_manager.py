...
Uses preset scripts + LLM intelligent configuration generation
"""
...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        Steps:
        1. Read and filter entities from Zep graph
        2. Generate OASIS Agent Profile for each entity (optional LLM enhancement, supports parallel generation)
        ...
        Args:
            ...
            simulation_requirement: Simulation requirement description (used by LLM for configuration generation)
            document_text: Original document content (used by LLM for context understanding)
            ...
            parallel_profile_count: Number of profiles to generate in parallel, default is 3
        ...
        try:
            ...
            # Pass graph_id to enable Zep retrieval functionality for richer context
