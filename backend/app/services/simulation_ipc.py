...
3. Flask polls responses directory to get results
"""
...
class SimulationIPCClient:
    ...
    def send_command(
        ...
        while time.time() - start_time < timeout:
            if os.path.exists(response_file):
                try:
                    ...
                    # Cleanup command and response files
                    try:
        ...
        # Timeout
        logger.error(f"Waiting for IPC response Timeout: command_id={command_id}")
        ...
        raise TimeoutError(f"Waiting for command response Timeout ({timeout}s)")
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: Dual-platform simulation interviews both platforms, single-platform simulation interviews that platform
            timeout: Timeout
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: Default platform (optional, will be overridden by each interview item platform)
                - "twitter": Default Only interview Twitter platform
                - "reddit": Default Only interview Reddit platform
                - None: Dual-platform simulation interviews both platforms for each Agent
            timeout: Timeout
...
class SimulationIPCServer:
    ...
    Poll commands directory, execute commands and return responses
    """
