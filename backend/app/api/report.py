...
def get_report_sections(report_id: str):
    ...
    Frontend can poll this interface to get generated section content without waiting for the entire report
...
def get_agent_log(report_id: str):
    ...
    Real-time retrieval of every action during report generation, including:
...
def stream_agent_log(report_id: str):
    """
    Get complete Agent logs (get all at once)
...
def get_console_log(report_id: str):
    ...
    which is different from the structured JSON logs returned by the agent-log interface,
    this is plain text format console-style logs.
...
def stream_console_log(report_id: str):
    """
    Get complete console logs (get all at once)
