    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Combining context, automatically invoke tools to extract entities and relationships from the knowledge graph, initialize simulation agents, and endow them with unique behaviors and memories based on real-world seeds
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            The LLM intelligently sets world time flow rate, recommendation algorithms, active time periods for each agent, posting frequency, event triggers, and other parameters based on simulation requirements and real-world seeds
          </p>
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div class="config-block">
              <div class="config-grid">
                ...
                <div class="config-item">
                  <span class="config-item-label">Active Agents/Hour</span>
      ...
      <div v-if="selectedProfile" class="profile-modal-overlay" @click.self="selectedProfile = null">
        ...
        <div class="modal-body">
          ...
          <div class="modal-info-grid">
            <div class="info-item">
              <span class="info-label">Event Display Age</span>
              <span class="info-value">{{ selectedProfile.age || '-' }} years</span>
            </div>
            <div class="info-item">
              <span class="info-label">Event Display Gender</span>
            ...
            <div class="info-item">
              <span class="info-label">Event Display MBTI</span>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            ...
            <div class="persona-dimensions">
              ...
              <div class="dimension-card">
                ...
                <span class="dim-desc">Memories formed based on real-world seeds</span>
              </div>
              <div class="dimension-card">
...
// Log deduplication: track last logged key information
...
// Calculate auto-generated rounds from config (without using hardcoded defaults)
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.already_prepared) {
        addLog('Detected existing preparation, using directly')
...
const fetchProfilesRealtime = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Only update when API returns valid value to avoid overwriting existing valid values
    ...
    if (res.success && res.data) {
      ...
      if (data.config_generated && data.config) {
        ...
        if (data.config.time_config) {
          ...
          addLog(`Time config: ${tc.minutes_per_round} min per round, ${Math.floor((tc.total_simulation_hours * 60) / tc.minutes_per_round)} rounds total`)
        }
...
const loadPreparedData = async () => {
  ...
  // Finally fetch profiles one more time
