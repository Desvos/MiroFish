...
/**
 * Get generating Agent Profiles in real-time
 * @param {string} simulationId
 * @param {string} platform - 'reddit' | 'twitter'
 */
...
/**
 * Get generating simulation config in real-time
 * @param {string} simulationId
 * @returns {Promise} Return config info, including metadata and content
 */
...
/**
 * Get simulation running real-time status
 * @param {string} simulationId
 */
...
/**
 * Get simulation running detailed status (including recent actions)
 * @param {string} simulationId
 */
