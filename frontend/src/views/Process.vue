    ...
    <div class="main-content">
      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        ...
        <div class="graph-container" ref="graphContainer">
          <!-- Graph visualization (show if data exists) -->
          ...
          <div v-else-if="currentPhase < 1" class="graph-waiting">
            ...
            <p class="waiting-hint">Will auto-start graph build after generation</p>
          </div>
          ...
          <div v-else-if="currentPhase === 1 && !graphData" class="graph-waiting">
            ...
            <p class="waiting-text">Graph building</p>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API Documentation</div>
                <div class="detail-content">
                  After uploading documents, LLM analyzes content and auto-generates ontology suitable for opinion simulation (entity types + relation types)
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API Documentation</div>
                <div class="detail-content">
                  Based on generated ontology, split documents and call Zep API to build knowledge graph, extract entities and Relations
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 2, 'completed': currentPhase > 2 }">
            <div class="phase-header">
              ...
              <div class="phase-info">
                ...
                <div class="phase-api">Ready to enter next step</div>
              </div>
...
// Current project ID (may change from'newto actual ID)
...
const currentPhase = ref(-1) // // -1: uploading, 0: ontology generating, 1: Graph Build, 2: complete
...
const statusText = computed(() => {
  ...
  if (currentPhase.value === 1) return 'Graph building'
...
// Init - handle new project or load existing project
...
const handleNewProject = async () => {
  ...
  if (!pending.isPending || pending.files.length === 0) {
    error.value = 'No pending upload files, please return to homepage and try again'
    loading.value = false
    return
  }
...
const renderGraph = () => {
  ...
  // Create nodes mapping for name lookup
  const nodeMap = {}
  nodesData.forEach(n => {
    nodeMap[n.uuid] = n
  })
  ...
  // Draw edges (including clickable transparent wide line)
