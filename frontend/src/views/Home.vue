    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class=”hero-desc”>
            <p>
              Even with just a piece of text, <span class=”highlight-bold”>MiroFish</span> can automatically generate a parallel world with up to <span class=”highlight-orange”>millions of Agents</span> based on the reality seeds within. Through a god's-eye view, inject variables and find <span class=”highlight-code”>”local optima”</span> in dynamic environments through complex group interactions.
            </p>
            <p class=”slogan-text”>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            Prediction engine on standby. Upload unstructured data to initialize simulation sequence.
          </p>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity relation extraction & Profile generation & Environment config injection</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & Auto prediction parsing & Dynamic memory update</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">ReportAgent with rich toolset for deep interaction with simulated environment</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Chat with any agent in the simulated world & Talk with ReportAgent</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter simulation or prediction requirements in natural language (e.g., What would happen if...)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
// Start simulation - Immediate redirect, API call happens on Process page
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Immediately redirect to Process page (using special identifier to indicate new project)
    router.push({
      name: 'Process',
...
:root {
  ...
  --border: #E5E5E5;
  /* 
    Using Space Grotesk as primary heading font, JetBrains Mono as code/label font
